...
| **Workflow automation** — opt-in auto-assignment (least-loaded coordinator) + confidence-gated auto-dispatch of routing suggestions, per-agency policy | ✅ | `src/domain/workflow.ts`, `src/services/taskService.ts`, admin “Workflow automation” card |
